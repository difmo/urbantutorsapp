// lib/screens/tutor/tutor_coins_screen.dart
...
class TutorCoinsScreen extends StatefulWidget {
  ...
  @override
  State<TutorCoinsScreen> createState() => _TutorCoinsScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: _c.refreshAll, icon: const Icon(Icons.refresh))
        ],
      ),
