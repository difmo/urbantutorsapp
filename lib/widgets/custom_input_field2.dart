...
class CustomInputField2 extends StatefulWidget {
  ...
  final String Function(String) capitalizeEach; // Function to format input
...
class _CustomInputFieldState extends State<CustomInputField2> {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      onChanged: (val) {
        final formatted = widget.capitalizeEach(val);
        if (formatted != val) {
      ...
      onEditingComplete: () {
        final formatted = widget.capitalizeEach(widget.controller.text);
